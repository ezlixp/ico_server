 ...
 * @param {Express} app
 */
function mapWaitlistEndpoints(app: Application) {
    app.get("/waitlist", async (request: Request, response: Response) => {
        try {
    ...
    app.post("/waitlist", validateJwtToken, async (request: Request, response: Response) => {
        try {
    ...
    app.delete("/waitlist/:username", validateJwtToken, async (request: Request, response: Response) => {
        try {
